...
# The method should  a new array where every even number is divided by 2 and every odd
...
# p half_and_double([4, 5, 7, 10]) # => eq([2, 10, 14, 5])
# p half_and_double([20, 25, 12, 13]) # => eq([10, 50, 6, 26])