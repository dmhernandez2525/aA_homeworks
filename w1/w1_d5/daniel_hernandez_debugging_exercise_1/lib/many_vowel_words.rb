...
def many_vowel_words(sentence)
    ...
    new_words = words.select do |word|
        num_vowels = num_vowels(word) if num_vowels(word) >= 2
    end
    new_words.join(" ")
end
...
# puts many_vowel_words("Hello world, how are you")# =>("Hello are you")
# puts many_vowel_words("The quick brown fox jumps over the lazy dog")# =>("quick over")
# puts many_vowel_words("The Missippi river is quite the river")# =>("Missippi river quite river")
