...
def my_rotate!(array, amt)
    if amt > 0
        # amt.times{array.unshift(array.pop)} this was my first thought because it
        #rotates the entire array clock wise causing the last element to become the first
        amt.times{array.push(array.shift)}
    else
        amt*=-1
        # amt.times{array.push(array.shift)} this was my first thought because it
        #rotates the entire array clock wise causing the last element to become the first
